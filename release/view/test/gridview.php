...
<script type="text/javascript" charset="utf-8" src="/static/ddui/js/module_page.js"></script>
<script type="text/javascript" charset="utf-8" src="/static/ddui/js/widget_gridview.js"></script>
<script>
    var LIST = [
        {name: "zhuce", text: "注册"},
        {name: "hujiao", text: "呼叫"},
